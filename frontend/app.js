...
// URI exacto registrado en el dashboard de Spotify — NO usar window.location (falla en file://)
const SPOTIFY_REDIRECT_URI = 'https://main.d3l36ughrz7z5g.amplifyapp.com/';
